...
RUN apt update
RUN apt-get install -y --install-recommends sudo bison bzip2 cmake curl doxygen flex g++-6 gdb m4 mercurial moreutils pkg-config python python-dev python-pip
